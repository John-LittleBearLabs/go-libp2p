...
import (
	...
	coretest "github.com/John-LittleBearLabs/go-libp2p/core/test"
	blhost "github.com/John-LittleBearLabs/go-libp2p/p2p/host/blank"
	...
	mocknet "github.com/John-LittleBearLabs/go-libp2p/p2p/net/mock"
	...
	"github.com/John-LittleBearLabs/go-libp2p/p2p/protocol/identify"
...
func TestNotListening(t *testing.T) {
	...
	//
	// https://github.com/John-LittleBearLabs/go-libp2p/issues/939
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
