...
//go:generate sh -c "mockgen -package pstoremanager_test -destination mock_peerstore_test.go github.com/John-LittleBearLabs/go-libp2p/core/peerstore Peerstore"
